...
public class CommentController {
    ...
    public CommonResult getList(
        ...
        List<CmsComment> List = commentService.listPoetry(username, articleId, ip, pageNum, pageSize, sortBy);
    ...
    @PostMapping("/delete")
    public CommonResult delPoetry(@RequestParam("ids") List<Long> ids, @RequestParam("aids") List<Long> aids) {
